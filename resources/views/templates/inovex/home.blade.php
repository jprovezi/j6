...
@section('description','Programação web, criação de sites, sistemas prontos, Google ADS, gestão de redes sociais e artes offline. Soluções completas para sua empresa.')
                ...
                <div class="about-one__content">
                    ...
                    <div class="about-one__box-wrapper">
                        ...
                        <div class="about-one__box">
                            ...
                            <div class="about-one__box-content">
                                <h3>Preços justos ao mercado</h3>
                                <p>Trabalhamos com valores justos e competitivos ao mercado atual.</p>
                            </div><!-- /.about-one__box-content -->
                        </div><!-- /.about-one__box -->
                        <div class="about-one__box">
                            <div class="about-one__box-icon">
                            ...
                            <div class="about-one__box-content">
                                ...
                                <p>Nosso atendimento é diferenciado, sempre dando máxima atenção aos nossos clientes.</p>
                            </div><!-- /.about-one__box-content -->
                        </div><!-- /.about-one__box -->
