...
-- Copiando estrutura para tabela j6.config
...
-- Copiando dados para a tabela j6.config: ~0 rows (aproximadamente)
INSERT INTO `config` (`id`, `limit_page`, `template`) VALUES
	(1, 25, 'inovex');

-- Copiando estrutura para tabela j6.empresa
...
-- Copiando dados para a tabela j6.empresa: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela j6.full_banner
...
-- Copiando dados para a tabela j6.full_banner: 1 rows
...
-- Copiando estrutura para tabela j6.leads
...
-- Copiando dados para a tabela j6.leads: 0 rows
/*!40000 ALTER TABLE `leads` DISABLE KEYS */;
/*!40000 ALTER TABLE `leads` ENABLE KEYS */;

-- Copiando estrutura para tabela j6.log
...
-- Copiando dados para a tabela j6.log: ~16 rows (aproximadamente)
...
-- Copiando estrutura para tabela j6.menu
...
-- Copiando dados para a tabela j6.menu: ~33 rows (aproximadamente)
...
-- Copiando estrutura para tabela j6.notificacoes
...
-- Copiando dados para a tabela j6.notificacoes: ~8 rows (aproximadamente)
...
-- Copiando estrutura para tabela j6.produtos
...
-- Copiando dados para a tabela j6.produtos: ~0 rows (aproximadamente)
...
-- Copiando estrutura para tabela j6.produtos_categoria
...
-- Copiando dados para a tabela j6.produtos_categoria: ~0 rows (aproximadamente)

-- Copiando estrutura para tabela j6.seo
...
-- Copiando dados para a tabela j6.seo: ~2 rows (aproximadamente)
INSERT INTO `seo` (`id`, `title`, `description`, `keywords`, `obs`) VALUES
	(1, 'J6 Soluções Digitais', 'Soluções Digitais para a sua empresa decolar como um foguete', 'google ads, postagens profissionais nas redes sociais, criação de sites', 'index'),
	(2, 'Página não encontrada', 'Essa página não foi encontrada, ela deve ter sido engolida por um buraco negro', '404, notfound, página não encontrada', 'Página 404');

-- Copiando estrutura para tabela j6.single_url
...
-- Copiando dados para a tabela j6.single_url: ~1 rows (aproximadamente)
INSERT INTO `single_url` (`id`, `controlador`, `view`, `tabela`, `id_busca`) VALUES
	(4, 'fazendobiscoitos', 'blog', 'produtos', 50);

-- Copiando estrutura para tabela j6.usuarios
...
-- Copiando dados para a tabela j6.usuarios: ~0 rows (aproximadamente)
