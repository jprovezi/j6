...
class ArtesOffline extends Controller
{
    ...
    public function detalhes()
    {
        ...
        $dados["jobs"] = $this->modelProjetos->getAll(array("where" => "categoria_id = 20", "orderBy" => "rand()", "limit" => "10"));
        $dados["tituloJobs"] = "Confira alguns trabalhos gráficos";
