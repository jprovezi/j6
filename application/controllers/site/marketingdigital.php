...
class MarketingDigital extends Controller
{
    ...
    public function detalhes()
    {
        ...
        $dados["jobs"] = $this->modelProjetos->getAll(array("where" => "categoria_id = 24", "orderBy" => "rand()", "limit" => "10"));
        $dados["tituloJobs"] = "Alguns trabalhos de marketing executados";
