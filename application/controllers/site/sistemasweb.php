...
class SistemasWeb extends Controller
{
    ...
    public function detalhes()
    {
        ...
        $dados["jobs"] = $this->modelProjetos->getAll(array("where" => "categoria_id = 25", "orderBy" => "rand()", "limit" => "10"));
        $dados["tituloJobs"] = "Alguns cases de sucesso";
