...
class ProdutosModel extends Model {
     ...
     * @return void
     */
    public function getAllProdutosCategorias() {
        $query = "SELECT
        ...
        JOIN site_produtos_categoria spc
    ...
    public function getAllCategoriaAtivas() {
        ...
        FROM site_produtos_categoria spc
        INNER JOIN site_produtos sp
