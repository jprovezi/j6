...
class ProjetosModel extends Model {
     ...
     * @return void
     */
    public function getAllProjetosCategorias() {
        $query = "SELECT

        sp.id, sp.titulo, sp.texto, sp.capa, sp.dir_galeria, sp.url_video, sp.categoria_id, sp.ativo, sp.destaque, spc.titulo AS categoria
        
        FROM site_projetos sp
        JOIN site_projetos_categoria spc
    ...
    public function getAllCategoriaAtivas() {
        ...
        FROM site_projetos_categoria spc
        INNER JOIN site_projetos sp
